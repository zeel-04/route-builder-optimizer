---
name: astryx-ui
description: Use when building, editing, or reviewing any UI with the Astryx design system (@astryxdesign/*) — pages, screens, layouts, components, theming, tokens, or styling.
---

# Astryx UI

Astryx v0.6.0 · 90+ components
